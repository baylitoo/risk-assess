"""Run corpus-scale RiskOS regression evaluations and enforce quality gates."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=CorpusSplit.REGRESSION.value,
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    except (CorpusError, OSError, ValueError, yaml.YAMLError) as exc:
...
def _load_thresholds(path: Path | None) -> EvalThresholds:
    if path is None:

...
fixture with a FakeGateway; live tests require RISKOS_PROXY_URL.
"""
...
from riskos.intake.inventory import create_inventory_extraction, materialize_inventory
...
# ---------------------------------------------------------------------------
# Live tests (require RISKOS_PROXY_URL)
# ---------------------------------------------------------------------------


@pytest.mark.live
def test_live_extraction_on_golden_dossier_meets_precision_recall():
    """Run the real gateway against the golden dossier and check P/R targets.

    Requires RISKOS_PROXY_URL and RISKOS_PROXY_API_KEY to be set.
    The golden inventory against which we measure is defined inline here;
    ...
    from riskos.evals.inventory import evaluate_inventory
